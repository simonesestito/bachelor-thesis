...
%%%%%%%%%%%%% https://reverseengineering.stackexchange.com/questions/23264/can-missing-section-headers-elf-files-still-be-executed-dangerous

\subsubsection{Analisi dell'entropia}
Notiamo un notevole aumento dell'entropia causato dalla compressione.
